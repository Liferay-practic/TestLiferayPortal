...
/**
 * Provides the local service interface for TestUser. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see TestUserLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface TestUserLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link TestUserLocalServiceUtil} to access the test user local service. Add custom service methods to <code>com.testService.service.impl.TestUserLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	public TestUser createTestUser(long customUserId);
	...
	public TestUser deleteTestUser(long customUserId) throws PortalException;
	...
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TestUser fetchTestUser(long customUserId);
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public TestUser getTestUser(long customUserId) throws PortalException;
	 ...
	 */
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<TestUser> getTestUsers(int start, int end);
