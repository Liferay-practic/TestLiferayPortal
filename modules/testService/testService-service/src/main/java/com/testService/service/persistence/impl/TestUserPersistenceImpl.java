...
public class TestUserPersistenceImpl
	 ...
	 */
	@Override
	public List<TestUser> findByUuid(String uuid) {
	 ...
	 */
	@Override
	public List<TestUser> findByUuid(String uuid, int start, int end) {
	 ...
	 */
	@Override
	public List<TestUser> findByUuid(
		...
		if (useFinderCache) {
			...
			if ((list != null) && !list.isEmpty()) {
				for (TestUser testUser : list) {
					if (!uuid.equals(testUser.getUuid())) {
						list = null;
	...
	public TestUser findByUuid_First(
		...
		TestUser testUser = fetchByUuid_First(uuid, orderByComparator);
	...
	public TestUser fetchByUuid_First(
		...
		List<TestUser> list = findByUuid(uuid, 0, 1, orderByComparator);
	...
	public TestUser findByUuid_Last(
		...
		TestUser testUser = fetchByUuid_Last(uuid, orderByComparator);
	...
	public TestUser[] findByUuid_PrevAndNext(
		...
		TestUser testUser = findByPrimaryKey(customUserId);
		...
		try {
			...
			TestUser[] array = new TestUserImpl[3];

			array[0] = getByUuid_PrevAndNext(
				session, testUser, uuid, orderByComparator, true);

			array[1] = testUser;

			array[2] = getByUuid_PrevAndNext(
				session, testUser, uuid, orderByComparator, false);
	...
	protected TestUser getByUuid_PrevAndNext(
		Session session, TestUser testUser, String uuid,
		OrderByComparator<TestUser> orderByComparator, boolean previous) {
		...
		if (orderByComparator != null) {
			for (Object orderByConditionValue :
					orderByComparator.getOrderByConditionValues(testUser)) {
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 =
		"(testUser.uuid IS NULL OR testUser.uuid = '')";
	...
	public TestUser updateImpl(TestUser testUser) {
		...
		if (Validator.isNull(testUser.getUuid())) {
			String uuid = PortalUUIDUtil.generate();
		...
		if (!_columnBitmaskEnabled) {
			...
			Object[] args = new Object[] {testUserModelImpl.getUuid()};
			...
			if ((testUserModelImpl.getColumnBitmask() &
				...
				Object[] args = new Object[] {
					testUserModelImpl.getOriginalUuid()
				};
				...
				args = new Object[] {testUserModelImpl.getUuid()};
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByUuid = new FinderPath(
			...
			TestUserModelImpl.UUID_COLUMN_BITMASK);
